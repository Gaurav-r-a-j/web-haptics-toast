          ...
          <div className="lg:col-span-8 flex flex-col justify-start">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-12 text-left items-start">
              <div className="flex flex-col gap-4">
                {/* <p className="text-[10px] font-black uppercase tracking-wide">Core Docs</p> */}
                <HeroText shadowColor="#000000" className="text-lg mb-4 md:text-xl lg:text-2xl  text-white leading-[0.85] uppercase tracking-tighter"> Docs</HeroText>
              ...
              <div className="flex flex-col gap-4">
                <HeroText shadowColor="#000000" className="text-lg md:text-xl lg:text-2xl mb-4 text-white leading-[0.85] uppercase tracking-tighter"> Reference </HeroText>
              ...
              <div className="flex flex-col gap-4">
                <HeroText shadowColor="#000000" className="text-lg md:text-xl lg:text-2xl mb-4 text-white leading-[0.85] uppercase tracking-tighter"> Explore More </HeroText>
      ...
      <div className="w-full border-t border-primary-foreground/10 py-10">
        <div className="container mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href={LINKS.X} target="_blank" rel="noopener noreferrer" className="text-white opacity-100 hover:opacity-80 transition-opacity" title="Twitter / X">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
            </a>
            <a href={LINKS.NPM} target="_blank" rel="noopener noreferrer" className="text-white opacity-100 hover:opacity-80 transition-opacity" title="NPM">
            ...
            <a href={LINKS.STUDIO} target="_blank" rel="noopener noreferrer" className="text-white opacity-100 hover:opacity-80 transition-opacity" title="Website">
